...
var lyr_LandCover_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Land Cover<br />\
    <img src="styles/legend/LandCover_1_0.png" /> Built-up<br />\
    <img src="styles/legend/LandCover_1_1.png" /> Bare Areas<br />\
    <img src="styles/legend/LandCover_1_2.png" /> Orchards and plantations<br />\
    <img src="styles/legend/LandCover_1_3.png" /> Sparse natural vegetation<br />\
    <img src="styles/legend/LandCover_1_4.png" /> Dense natural vegetation<br />\
    <img src="styles/legend/LandCover_1_5.png" /> Paddy rice<br />\
    <img src="styles/legend/LandCover_1_6.png" /> Maize<br />\
    <img src="styles/legend/LandCover_1_7.png" /> Cassava<br />\
    <img src="styles/legend/LandCover_1_8.png" /> Sugarcane<br />\
    <img src="styles/legend/LandCover_1_9.png" /> Annual crops and Grassland<br />\
    <img src="styles/legend/LandCover_1_10.png" /> Steep slope agriculture<br />\
    <img src="styles/legend/LandCover_1_11.png" /> Water bodies<br />\
    <img src="styles/legend/LandCover_1_12.png" /> <br />' });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_LandCover_1.setVisible(true);lyr_CassavaSuitability_2.setVisible(true);lyr_MaizeSuitability_3.setVisible(true);lyr_RiceSuitability_4.setVisible(true);lyr_SoilWRB_5.setVisible(true);lyr_SoilProfiles_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_LandCover_1,group_CropSuitability,lyr_SoilWRB_5,lyr_SoilProfiles_6];
lyr_LandCover_1.set('fieldAliases', {'LCCS02': 'LCCS02', 'LCCS01': 'LCCS01', 'Eng_Name': 'Eng_Name', 'LCC01_Name': 'LCC01_Name', 'LCCS02_Nam': 'LCCS02_Nam', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'Area_HA': 'Area_HA', });
...
lyr_LandCover_1.set('fieldImages', {'LCCS02': 'TextEdit', 'LCCS01': 'TextEdit', 'Eng_Name': 'TextEdit', 'LCC01_Name': 'TextEdit', 'LCCS02_Nam': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'Area_HA': 'TextEdit', });
...
lyr_LandCover_1.set('fieldLabels', {'LCCS02': 'inline label - always visible', 'LCCS01': 'inline label - visible with data', 'Eng_Name': 'inline label - always visible', 'LCC01_Name': 'inline label - always visible', 'LCCS02_Nam': 'inline label - always visible', 'Shape_Leng': 'inline label - always visible', 'Shape_Area': 'inline label - always visible', 'Area_HA': 'inline label - always visible', });
